...
<script src="../View/js/noticeUp.js"></script>
<link rel="stylesheet" href="../View/css/noticeUp.css"></link>
</head>
<body>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {  
   ...
   if(!$flag) 
   {
     ...
     $course = input_data($_POST["course"]);
        ...
        $noticeUp = noticeUp($title, $notice, $date, $section, $course, $noid);  
        if($noticeUp) {
        $successfulMessage = "Notice successfully Updated";
        }
        else {
